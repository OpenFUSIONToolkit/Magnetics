...
function PanelPlaceholder({ text, height = 200 }: { text: string; height?: number }) {
  return (
    <div style={{
      ...
      color: "var(--text-dim)", fontSize: "13px", textAlign: "center", padding: "12px",
    ...
    return (
      <div style={{ display: "flex", flexDirection: "row", height: "270px", gap: "0px" }}>
        <div style={{ width: subintervalLeftWidth, overflow: "auto", flexShrink: 0 }}>
          <h4 style={{ fontSize: "13px", textTransform: "uppercase", color: "var(--text-dim)", margin: "0 0 8px" }}>
            Raw Signal <span style={{ textTransform: "none" }}>dB/dt (4&nbsp;ms window)</span>
          </h4>
          {rawTrace
            ? <Plot data={rawPlotData} height={225} layout={{ margin: { l: 40, r: 10, t: 10, b: 44 }, xaxis: { title: { text: "Time (ms)" } } }} />
            : <PanelPlaceholder text="raw dB/dt trace — not yet wired to the backend" height={225} />}
        </div>
        ...
        <div style={{ flex: 1, overflow: "auto", paddingLeft: "8px" }}>
          ...
          <Plot data={specSubplotsData} layout={specSubplotsLayout} height={225} />
        </div>
      </div>
    );
  };
  ...
  const analysisCard = (
    ...
    return (
      ...
      <div className="card" style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: "8px", margin: "7px 0 0 0", minHeight: 0 }}>
        <h4 style={{ margin: 0, fontSize: "13px", fontWeight: 600, textTransform: "uppercase", color: "var(--accent)" }}>
          {title}
        ...
        {sidebarExpanded && (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", height: "100%", overflowY: "auto" }}>
            ...
            <div style={{ borderBottom: "1px solid var(--border)", paddingBottom: "10px" }}>
              ...
              <div style={{ fontSize: "13px", fontWeight: 600, color: dataSourceColor }}>
                {dataSourceText}
              </div>
            </div>
            ...
            {channelInfo && (
              <details style={{ borderBottom: "1px solid var(--border)", paddingBottom: "10px" }}>
                <summary style={{ fontSize: "12px", color: "var(--text-dim)", textTransform: "uppercase", cursor: "pointer" }}>
                ...
                <div style={{ marginTop: "8px", display: "flex", flexDirection: "column", gap: "8px", maxHeight: "220px", overflowY: "auto" }}>
                  <div>
                    <div style={{ fontSize: "11px", color: "var(--good)", textTransform: "uppercase", marginBottom: "3px" }}>
                      Used ({channelInfo.used.length})
                    </div>
                    {channelInfo.used.map((c) => (
                      <div key={c.name} style={{ fontSize: "12px", fontFamily: "monospace", lineHeight: 1.45, display: "flex", justifyContent: "space-between", gap: "6px" }}>
                  ...
                  {channelInfo.unused.length > 0 && (
                    <div>
                      <div style={{ fontSize: "11px", color: "var(--text-dim)", textTransform: "uppercase", marginBottom: "3px" }}>
                        Idle — droppable ({channelInfo.unused.length})
                      </div>
                      <div style={{ fontSize: "12px", fontFamily: "monospace", lineHeight: 1.45, color: "var(--text-dim)", wordBreak: "break-all" }}>
            ...
            {processedSpecNode && (
              <div style={{ display: "flex", flexDirection: "column", gap: "4px", borderBottom: "1px solid var(--border)", paddingBottom: "10px" }}>
                <label htmlFor="time-range" style={{ fontSize: "13px", color: "var(--text-dim)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px" }}>
              <div>
                <label htmlFor="fmin-input" style={{ fontSize: "13px", color: "var(--text-dim)", display: "block", marginBottom: "2px" }}>
                  f_min (kHz)
                </label>
                <input
                  id="fmin-input"
              ...
              <div>
                <label htmlFor="fmax-input" style={{ fontSize: "13px", color: "var(--text-dim)", display: "block", marginBottom: "2px" }}>
                  f_max (kHz)
                </label>
                <input
                  id="fmax-input"
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              <label htmlFor="fittype-select" style={{ fontSize: "13px", color: "var(--text-dim)" }}>Poloidal Fit (fittype) <em style={{ opacity: 0.7 }}>(not wired)</em></label>
              <select
                id="fittype-select"
                value={fittype}
            ...
            >
              <label htmlFor="smoothing-range" style={{ fontSize: "13px", color: "var(--text-dim)" }}>
            ...
            >
              <label htmlFor="power-gate-range" style={{ fontSize: "13px", color: "var(--text-dim)" }}>
              ...
              {advancedExpanded && (
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "8px", borderTop: "1px dashed var(--border-2)", paddingTop: "8px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                    <label htmlFor="fft-window-select" style={{ fontSize: "12px", color: "var(--text-dim)" }}>FFT Window Size</label>
                    <select
                  ...
                  {/* FFT Overlap slider */}
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                    <label htmlFor="fft-overlap-range" style={{ fontSize: "12px", color: "var(--text-dim)" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                    <span style={{ fontSize: "12px", color: "var(--text-dim)" }}>Toroidal Probes (φ)</span>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px" }}>
                      <div>
                        <label htmlFor="phi1-input" style={{ fontSize: "11px", color: "var(--text-dim)", display: "block" }}>Probe 1</label>
                        <input
                          id="phi1-input"
                          type="number"
                          min="0"
                      ...
                      <div>
                        <label htmlFor="phi2-input" style={{ fontSize: "11px", color: "var(--text-dim)", display: "block" }}>Probe 2</label>
                        <input
                          id="phi2-input"
                          type="number"
                          min="0"
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0px", minWidth: 0, overflowY: "auto", paddingRight: "6px", height: "100%" }}>
        ...
        <div className="card" style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: "8px", margin: 0, height: specHeight, minHeight: 0 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <h3 style={{ margin: 0, fontWeight: 600, fontSize: "15px" }}>Spectrogram Ḃ<sub>p</sub>(t, f)</h3>
              <span style={{ fontSize: "15px", color: "var(--text-dim)" }}>
            ...
            {hasStaticFiles && (
              <select
                ...
                style={{ background: "var(--panel-2)", color: "var(--text)", border: "1px solid var(--border-2)", padding: "3px 6px", borderRadius: "4px", fontSize: "15px", outline: "none" }}
              >
        ...
        {processedPatternNode && processedPatternNode.kind === "contour" && (
          <div className="card" style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: "8px", margin: "7px 0 0 0", minHeight: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "row", gap: "6px", flex: 1, minHeight: 0 }}>
              ...
              >
                <span style={{ fontSize: "11px", color: "var(--text-dim)", whiteSpace: "nowrap" }}>θ orig</span>
                <input
                ...
                />
                <span style={{ fontSize: "11px", color: "var(--text)" }}>{patternCut}°</span>
              </div>
              <div style={{ flex: 1, minHeight: 0 }}>
                {renderModePattern()}
              </div>
